...
type OSVClient interface {
	...
	GetVulnById(ctx context.Context, in *GetVulnByIdParameters, opts ...grpc.CallOption) (*Vulnerability, error)
...
func (c *oSVClient) GetVulnById(ctx context.Context, in *GetVulnByIdParameters, opts ...grpc.CallOption) (*Vulnerability, error) {
	out := new(Vulnerability)
	err := c.cc.Invoke(ctx, OSV_GetVulnById_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oSVClient) QueryAffected(ctx context.Context, in *QueryAffectedParameters, opts ...grpc.CallOption) (*VulnerabilityList, error) {
	...
	err := c.cc.Invoke(ctx, OSV_QueryAffected_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oSVClient) QueryAffectedBatch(ctx context.Context, in *QueryAffectedBatchParameters, opts ...grpc.CallOption) (*BatchVulnerabilityList, error) {
	...
	err := c.cc.Invoke(ctx, OSV_QueryAffectedBatch_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oSVClient) DetermineVersion(ctx context.Context, in *DetermineVersionParameters, opts ...grpc.CallOption) (*VersionMatchList, error) {
	...
	err := c.cc.Invoke(ctx, OSV_DetermineVersion_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *oSVClient) ImportFindings(ctx context.Context, in *ImportFindingsParameters, opts ...grpc.CallOption) (*ImportFindingList, error) {
	...
	err := c.cc.Invoke(ctx, OSV_ImportFindings_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OSVServer interface {
	// Return a `Vulnerability` object for a given OSV ID.
	GetVulnById(context.Context, *GetVulnByIdParameters) (*Vulnerability, error)
	// Query vulnerabilities for a particular project at a given commit or
	// version.
...
func (UnimplementedOSVServer) GetVulnById(context.Context, *GetVulnByIdParameters) (*Vulnerability, error) {
